...
insert into user values('AD', 102, 'ia1', 1, 1, 'ia1', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
insert into user values('AD', 103, 'ia2', 2, 1, 'ia2', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
...
insert into user values('AD', 202, 'ia21', 1, 2, 'ia21', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
insert into user values('AD', 203, 'ia22', 2, 2, 'ia22', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
...
insert into user values('RU', 302, 'ia4', 1, 0, 'ia4', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
insert into user values('RU', 303, 'ia5', 2, 0, 'ia5', 'markoradovic996@gmail.com', 'ia', 'ia', 'rrr', 123);
...
insert into user values('SA', 406, 'sa5', 1, 3, 'sa5', '', '', '', '', '');
insert into user values('SA', 407, 'sa6', 2, 3, 'sa6', '', '', '', '', '');
...
insert into showing values(1,8.0,120,'Action','Aridatha Wyatt, Marna House, Kaylee Marler or martin, Willetta Freeman, Olwen Kerslake, Conny Blee, Shela Hewitt','Military Fiction','Shir Goodsell-Johnson','','Description1', 1);
insert into showing values(2,8.0,150,'Drama','Lisabeth Havelock, Carley Parker, Malvina Savills','Black Swan','Joyce Glendinin','','Description2', 1);
insert into showing values(3,7.5,163,'Horror','Malva De la puelba, Dell Wadham, Laverne Sowermire, Ludovika Hewitt','Ghostland','Abbe Wyatt','','Description', 1);
insert into showing values(4,6.8,185,'Comedy','Gwenette Fielder, Darsie Faithful, Florrie Freeman','Repo Man','Jorrie De Aldburgh','','Description4', 1);
insert into showing values(5,8.1,124,'Adventure','Rianon Deering, Etta Milbanke, Kylynn Pettigrew, Albina Mcphail, Briana Gow','Bruc','Cosetta Orton','','Description5', 1);
insert into showing values(6,5.7,150,'Comedy','Francisca Roethke, Shell Philips, Gilberte Neal, Gillian Troup','Paul','Con Carna','','Description6', 1);
insert into showing values(7,8.3,136,'Action','Shelly Deering, Nannie Jeffrey, Millie Oversby obersby, Lucie Smithies, Germaine Jeffeaux','Assassins','Juliane Farrelly','','Description7', 0 );
insert into showing values(8,7.5,140,'Comedy','Reina Elkin, Gelya Hutchins, Stephine Blee','Space Jam','Hildegarde Oversby Obersby','','Description8', 0);
insert into showing values(9,8.1,166,'Action','Donia Atkinson, Moina Mcallister, Florencia Lockett','Blades','Gill De cabaret','','Description9', 0);
insert into showing values(10,7.9,174,'Adventure','Susanna Heslop, Claudia Butler, Minta Benham, Elianore Fielder','Centurion','Nadiya Ashley','','Description10', 0);
insert into showing values(11,5.7,152,'Adventure','Doe De carteret, Camella De la puelba, Pepi Chamley','Robin Hood','Darb Atkinson','','Description11', 0);
insert into showing values(12,6.9,132,'History','Berri Wight, Nelia Wyatt, Clarice Mcgehee, Dorolisa Glendinin','Spotlight','Dolli Benham','','Description12', 0);
